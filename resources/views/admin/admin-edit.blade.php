        ...
        <div class="body-content">
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('CrudAdmin.index') }}" class="btn btn-secondary me-5">Back</a>
                </div>
                ...
                <div class="mt-5 w-50">
                    ...
                    <form action="{{ route('CrudAdmin.update', $admin->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $admin->name }}" placeholder="Enter Username" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
