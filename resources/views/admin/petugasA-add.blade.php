...
<body>
    <div class="main">
        ...
        <div class="body-content">
            ...
            <div class="content">
                <h2>Add User Petugas</h2>

                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('petugasA') }}" class="btn btn-secondary me-5">Back</a>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="book_code" class="form-label">Petugas Code</label>
                                    <input type="text" name="book_code" id="book_code" class="form-control" placeholder="Enter Petugas Code" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="kelamin" id="kelamin" class="form-control select-multiple" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control" placeholder="Enter No. Handphone" required>
                            </div>
